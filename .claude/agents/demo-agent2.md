...
1. Append a line to the file tmp/logs/agents-output.txt. The line should contain "demo-agent2: "
   plus a timestamp.
2. reply with exactly: "I am demo agent number 2, I wrote to agents-output.txt."
